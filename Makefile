...
SOURCES = $(SRC_DIR)/visualizer.c $(SRC_DIR)/adc_driver.c $(SRC_DIR)/timer_driver.c $(SRC_DIR)/signal_processing.c $(SRC_DIR)/oled_driver.c $(SRC_DIR)/startup_gcc.c $(DRV_DIR)/rit128x96x4.c $(UTILS_DIR)/ustdlib.c
LIBS = -ldriver-cm3 -lm
OBJS = $(SOURCES:.c=.o)
